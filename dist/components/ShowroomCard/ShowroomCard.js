...
export function ShowroomCard({ body = DEFAULT_BODY, brandLabel = "Joker Originals", className, defaultFavourited = false, favourited, href = "#", imageAlt = "", imageSrc, onFavouriteChange, title = "This is a title", ...props }) {
    ...
    return (_jsxs("article", { ...props, className: cx("joker-showroom-card", className), children: [_jsxs("div", { className: "joker-showroom-card-top-rail", children: [_jsxs("div", { className: "joker-showroom-card-brand", children: [_jsx(JokerOriginalsIcon, {}), _jsx("span", { children: brandLabel })] }), _jsx("button", { ref: favouriteButtonRef, className: cx("joker-showroom-card-icon is-favourite", isFavourited && "is-active"), type: "button", "aria-label": `Favourite ${accessibleTitle}`, "aria-pressed": isFavourited, "data-showroom-card-action": true, onClick: handleFavouriteClick, children: _jsx(HeartIcon, { filled: isFavourited }) })] }), _jsxs("div", { className: "joker-showroom-card-media", children: [_jsx("div", { className: "joker-showroom-card-image", "data-showroom-card-image": "", children: imageSrc ? _jsx("img", { src: imageSrc, alt: imageAlt }) : null }), _jsx("a", { className: "joker-showroom-card-media-link", href: href, "aria-label": `Open ${accessibleTitle}` })] }), _jsx("div", { className: "joker-showroom-card-content", children: _jsxs("div", { className: "joker-showroom-card-copy", children: [_jsx("h3", { children: title }), _jsx("p", { children: body })] }) })] }));
}
