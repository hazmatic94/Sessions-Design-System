...
import styles from "./GameHeaderRail.module.css";
function cx(...classes) {
...
export function GameHeaderRail({ game = navigationItemRegistry.crash, gameIcon, rightLabel = "Fair Play", rightIcon = "fair-play", className = "" }) {
    ...
    return (_jsxs("div", { className: cx(styles.root, "joker-game-header-rail", className), "aria-label": "Game header", children: [_jsxs("div", { className: cx(styles.group, "joker-game-header-group"), children: [_jsx("span", { className: cx(styles.info, "joker-game-header-info"), "aria-hidden": "true", children: _jsx(InfoIcon, {}) }), _jsxs("span", { className: cx(styles.title, "joker-game-header-title"), children: [_jsx(HeaderIcon, { icon: resolvedGameIcon, className: cx(styles.gameIcon, "joker-game-header-game-icon") }), _jsx("span", { children: gameLabel })] })] }), _jsxs("div", { className: cx(styles.group, styles.fairPlay, "joker-game-header-group joker-game-header-fair-play"), children: [_jsx(HeaderIcon, { icon: rightIcon, className: cx(styles.fairPlayIcon, "joker-game-header-fair-play-icon") }), _jsx("span", { children: rightLabel })] })] }));
}
