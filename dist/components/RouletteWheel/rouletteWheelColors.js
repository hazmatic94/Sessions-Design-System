...
export const DEFAULT_POCKET_RED = [RW.pocketRedLight, RW.pocketRed, RW.pocketRedDark];
export const DEFAULT_POCKET_BLACK = [RW.pocketBlackLight, RW.pocketBlack, RW.pocketBlackDark];
export const DEFAULT_POCKET_GREEN = [RW.pocketGreenLight, RW.pocketGreen, RW.pocketGreenDark];
