...
import { rouletteWheelSpinOriginPercent, rouletteWheelViewBoxAttribute, } from "./rouletteWheelPaths.js";
...
export function assembleRouletteWheelBakedStage(svgMarkup, mount) {
    ...
    if (outerBallTrack) {
        const trackSvg = document.createElementNS(SVG_NS, "svg");
...
export function syncRouletteWheelBakedStage(wheelRoot, frame, showBall) {
