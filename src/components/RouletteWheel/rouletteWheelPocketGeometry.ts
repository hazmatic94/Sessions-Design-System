...
export const ROULETTE_OUTER_BALL_TRACK_OUTER_RADIUS =
  ROULETTE_FRAME_OUTER_RADIUS - ROULETTE_OUTER_RIM_WIDTH - 2;
/** Outer coloured number band (roughly half the pocket span, wells take the rest). */
export const ROULETTE_NUMBER_TRACK_DEPTH = 92;
export const ROULETTE_NUMBER_TRACK_INNER_RADIUS =
  ROULETTE_POCKET_OUTER_RADIUS - ROULETTE_NUMBER_TRACK_DEPTH;
/** Radial position for number labels — centred in the number track band. */
export const ROULETTE_LABEL_RADIUS =
  ROULETTE_POCKET_OUTER_RADIUS - ROULETTE_NUMBER_TRACK_DEPTH / 2 + 2;
...
export function buildCircularArcPath(
  centerX: number,
  centerY: number,
  radius: number,
  startAngleDeg: number,
...
export function buildLowerAnnulusBandPath(
  centerX: number,
  centerY: number,
  innerRadius: number,
  outerRadius: number,
...
export function buildAnnulusPath(
  centerX: number,
  centerY: number,
  innerRadius: number,
  outerRadius: number,
...
export function pocketBallStagePosition(
  ballPosition: RoulettePoint,
  wheelRotation: number,
  center: RoulettePoint = ROULETTE_POCKET_CENTER,
): RoulettePoint {
...
export function settledBallStagePosition(
  pocketBallPosition: RoulettePoint,
  pointerAngle: number,
  center: RoulettePoint = ROULETTE_POCKET_CENTER,
): RoulettePoint {
