...
} from "./rouletteWheelSpin.js";
import { startRouletteRollPingPong } from "./rouletteWheelRollPlayback.js";

let activeRollStop: (() => void) | null = null;
let activeBounceAudio: HTMLAudioElement | null = null;
...
export function playRouletteWheelSpinSound(
  ...
  settlingStartProgress = ROULETTE_WHEEL_SETTLING_START_PROGRESS,
) {
  if (typeof window === "undefined") {
    return;
  }
