import { setupSeamlessVideoLoop } from "../demo/seamlessVideoLoop.js?v=hero-video-loop-v2";

const SETTINGS = {
  dotSize: 1.4,
  gridStep: 4,
  videoSrc: "./assets/JokerGoldLogoV5-loop.mov?v=home-logo-v5-loop",
  dotAlpha: 0.44,
};
...
export function hydrateHomeHeroGrid(root = document) {
  root.querySelectorAll("[data-home-hero-grid]").forEach((hero) => {
    ...
    const dotRgb = parseHexColor(styles.getPropertyValue("--joker-black-100"), "#5f5f5f");
